...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-60043"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-v1",
      "problem_contract_sha256": "d49c4f89b1a96e5fa14377972fbb73aaee72913404ff255c6142818c6420e7e3",
      "problem_id": "problem:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a",
      "route_id": "route:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-source-fidelity-01",
      "graph_id": "graph:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Problem Let $\\mathcal{X}$ be an indexed family of filters on sets. Which of the below items are always pairwise equal? 1. The funcoid corresponding to this function (considered as a single argument function on indexed families) applied to the reloidal product of filters $\\mathcal{X}$. 2. The funcoid corresponding to this function (considered as a single argument function on indexed families) applied to the starred reloidal product of filters $\\mathcal{X}$. 3. $\\bigcap_{F\\in\\operatorname{up}^{\\mathrm{FCD}}\\prod^{\\mathrm{Strd}}\\mathcal{X}}\\langle f \\rangle F$."
          },
          "statement_sha256": "4d024dd2122c24ca3a9ed498d8c3bdeecee23017e9c2305763f5053f5e05b18e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-root",
      "route_id": "route:um-opg-60043-several-ways-to-apply-a-multivalued-mu-888e330a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-60043-b2e75e2f39c9",
        "url": "https://www.unsolvedmath.com/problems/OPG-60043"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
